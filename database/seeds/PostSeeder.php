...
class PostSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $post2 = \App\Post::create([
            'title' => 'Welcome To the World of Technology!',
            'excerpt' => Faker\Factory::create()->sentence(rand(10,18)),
            'content'=> Faker\Factory::create()->paragraphs(rand(3,7), true),
            'image' => 'posts/2.jpg',
        ...
        $post5 = \App\Post::create([
            'title' => 'We Came To Smoething New!',
            'excerpt' => Faker\Factory::create()->sentence(rand(10,18)),
            'content'=> Faker\Factory::create()->paragraphs(rand(3,7), true),
            'image' => 'posts/5.jpg',
            'category_id'=>$categoryDesign->id,
        ...
        $post1->tags()->attach([$tagCoding->id, $tagLaravel->id, $tagDesign->id]);

        $post2->tags()->attach([$tagCoding->id, $tagLaravel->id]);

        $post3->tags()->attach([$tagLaravel->id]);
        $post4->tags()->attach([$tagCoding->id, $tagLaravel->id]);
        $post5->tags()->attach([$tagCoding->id, $tagLaravel->id, $tagCustomers->id]);
